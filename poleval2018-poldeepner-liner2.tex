    ...
    \begin{figure}[ht]
        ...
        \begin{tikzpicture}
            ...
            \begin{tikzpicture}
             ...
             \node[shape=none,draw=white] (A) at (1,0) {Liner2};
             
             \draw [thick,color=red,dash dot] (0,-0.3) -- (1,-0.3);
             \node[shape=none,draw=white,dash dot] (B) at (1,-0.5) {BiLSTM-CRF};
             
             \draw [thick,color=blue,dash pattern={on 7pt off 2pt on 1pt off 2pt on 1pt off 3pt}] (0,-0.8) -- (1,-0.8);
             \node[shape=none,draw=white] (B) at (1,-1.0) {PolDeepNer};
